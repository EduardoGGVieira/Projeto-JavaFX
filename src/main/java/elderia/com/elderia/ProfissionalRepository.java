...
public class ProfissionalRepository {
    private static final String NOME_ARQUIVO = "profissionais_elderia.dat";

    @SuppressWarnings("unchecked")
    public static List<Profissional> listarTodos() {
        ...
        List<Profissional> listaRecuperada = new ArrayList<>();
        ...
        try {
            ...
            listaRecuperada = (List<Profissional>) objectInput.readObject();
    ...
    public static void salvarTodos(List<Profissional> lista) {
