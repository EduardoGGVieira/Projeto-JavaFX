...
public class CuidadorRepository {
    private static final String NOME_ARQUIVO = "Cuidador_elderia.dat";


    //ta copiado e colado do profissional, se der merda eu volto...
    @SuppressWarnings("unchecked")
    public static List<Cuidador> listarTodos() {
        ...
        List<Cuidador> listaRecuperada = new ArrayList<>();
        ...
        try {
            ...
            listaRecuperada = (List<Cuidador>) objectInput.readObject();
            ...
            System.err.println("Falto muita coisa, deu ruim: " + e.getMessage());
        } finally {
            ...
            try {
                ...
                System.out.println("Deu tudo certo ainda bem.");
            } catch (IOException ex) {
                System.err.println("Deu ruim em tudo, olha oq deu: " + ex.getMessage());
            }
        }
    ...
    public static void salvarTodos(List<Cuidador> lista) {
        ...
        try {
            ...
            System.out.println("Muito bom, até q tu sabe fazer o negócio.");

            // Deu merda faz isso
        } catch (IOException e) {
            System.err.println("Desista dos seus sonhos: " + e.getMessage());
        } finally {
            ...
            try {
                ...
                System.err.println("Erro Critico, Solução: Desistencia (Solução verdadeira:) " + ex.getMessage());
            }
        }
    }
}
