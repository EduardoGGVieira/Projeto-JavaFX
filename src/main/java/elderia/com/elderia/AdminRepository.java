...
public class AdminRepository {
    private static final String NOME_ARQUIVO = "admins_elderia.dat";
    ...
    public static List<Admin> listarTodos() {
        ...
        List<Admin> listaRecuperada = new ArrayList<>();
        ...
        try {
            ...
            listaRecuperada = (List<Admin>) objectInput.readObject();
    ...
    public static void salvarTodos(List<Admin> lista) {
